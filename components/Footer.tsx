                ...
                <footer className = 'bg-gray-900 text-gray-300 px-6 lg:px-8 py-12 select-none mt-auto'>
                    <div className = 'max-w-screen-xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-x-8'>
                        ...
                        <div>
                            ...
                            <nav className = 'mt-4'>
                                <ul className = 'space-y-2'>
                                    <a href = './sans' className = 'font-normal text-base hover:text-gray-100'>Login</a>
                                </ul>
                            </nav>
                        </div>
                        <div>
                            ...
                            <nav className = 'mt-4'>
                                <ul className = 'space-y-2'>
                                    <li>
                                        <a target = '_blank' href = './api_sans' className = 'font-normal text-base hover:text-gray-100'>API</a>
                                    </li>
                                    <li>
